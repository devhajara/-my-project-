...
<motion.div
  ...
  className="mt-8 flex justify-center gap-6 text-3xl"
>
  {/* X (Twitter) */}
  <a
    ...
    aria-label="X"
    className="hover:text-yellow-400 transition text-[#1DA1F2]"
  >
    <svg width="1.3em" height="1.3em" viewBox="0 0 24 24" fill="currentColor">
  ...
  <a
    ...
    rel="noopener noreferrer"
    aria-label="Telegram"
    className="hover:text-yellow-400 transition text-[#26A5E4]"
  >
    <svg width="1.3em" height="1.3em" viewBox="0 0 24 24" fill="currentColor">
  ...
  <a
    ...
    className="hover:text-yellow-400 transition text-[#17c671]"
  >
    <svg width="1.3em" height="1.3em" viewBox="0 0 36 36" fill="currentColor">
      <circle cx="18" cy="18" r="18" fill="#222" />
      <rect x="8" y="24" width="4" height="4" rx="1" fill="currentColor"/>
      <rect x="14" y="20" width="4" height="8" rx="1" fill="currentColor"/>
      <rect x="20" y="12" width="4" height="16" rx="1" fill="currentColor"/>
      <rect x="26" y="8" width="4" height="20" rx="1" fill="currentColor"/>
    </svg>
  </a>
  {/* TikTok */}
  <a
    ...
    rel="noopener noreferrer"
    aria-label="TikTok"
    className="hover:text-yellow-400 transition text-[#FE2C55]"
  >
    <svg width="1.3em" height="1.3em" viewBox="0 0 32 32" fill="currentColor">
  ...
  <a
    ...
    rel="noopener noreferrer"
    aria-label="YouTube"
    className="hover:text-yellow-400 transition text-[#FF0000]"
  >
    <svg width="1.3em" height="1.3em" viewBox="0 0 32 32" fill="currentColor">
  ...
  <a
    ...
    className="hover:text-yellow-400 transition text-[#C13584]"
  >
    <svg width="1.3em" height="1.3em" viewBox="0 0 32 32" fill="currentColor">
  ...
  <a
    ...
    rel="noopener noreferrer"
    aria-label="Website"
    className="hover:text-yellow-400 transition text-blue-400"
  >
    <FiGlobe size={28} />
  </a>
</motion.div>
